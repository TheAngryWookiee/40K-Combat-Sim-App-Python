...
class SimulationOptions(BaseModel):
    ...
    attacker_miracle_dice_policy: str | None = None
    attacker_miracle_dice_pool: list[int] = Field(default_factory=list)
    attacker_righteous_active: bool = False
    defender_righteous_active: bool = False
    attacker_hagiomnifex_mode: str | None = None
    defender_hagiomnifex_mode: str | None = None
    attacker_suffer_not_the_unfaithful_mode: str | None = None
    attacker_faith_and_fury_active: bool = False
    attacker_divine_guidance_active: bool = False
    defender_blinding_radiance_active: bool = False
    attacker_to_the_heart_of_heresy_active: bool = False
    attacker_sanctified_blows_active: bool = False
    defender_faithful_fortitude_active: bool = False
    attacker_harmonised_exorcism_active: bool = False
    attacker_devastating_reprise_active: bool = False
    attacker_passion_of_the_penitent_active: bool = False
    defender_purity_of_suffering_active: bool = False
    attacker_synaptic_imperative: str | None = None
    defender_synaptic_imperative: str | None = None
    defender_miracle_dice_policy: str | None = None
    defender_miracle_dice_pool: list[int] = Field(default_factory=list)
    ...
    attacker_target_closest_eligible: bool = False
    attacker_disembarked_from_transport: bool = False
    attacker_set_up_on_battlefield_this_turn: bool = False
    ...
    attacker_hellfire_rounds_active: bool = False
    attacker_kraken_rounds_active: bool = False
    attacker_dragonfire_rounds_active: bool = False
...
def apply_simulation_enhancement_modifiers(unit: dict[str, Any], enhancement_name: str | None) -> None:
    ...
    if enhancement_name.lower() == "flowing flesh":
        apply_feel_no_pain_to_unit(unit, 4)
